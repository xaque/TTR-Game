...
public class ServerGameState {
    ...
    private void createRoutes(){
        ...
        routes.add(new Route(City.CALGARY, City.WINNIPEG, Color.WHITE, 6, calgary_winnipeg));
        int[] vancouver_calgary = {96, 53, 131, 50, 168, 44};
        routes.add(new Route(City.VANCOUVER, City.CALGARY, Color.WILD, 3, vancouver_calgary));
        int[] seattle_calgary = {95, 113, 129, 111, 163, 97, 187, 70};
        routes.add(new Route(City.SEATTLE, City.CALGARY, Color.WILD, 4, seattle_calgary));
        int[] seattle_helena = {91, 133, 126, 140, 162, 148, 197, 156, 232, 164, 267, 171};
        routes.add(new Route(City.SEATTLE, City.HELENA, Color.YELLOW, 6, seattle_helena));
        int[] calgary_helena = {216, 68, 239, 94, 262, 121, 285, 149};
        routes.add(new Route(City.CALGARY, City.HELENA, Color.WILD, 4, calgary_helena));
        int[] helena_winnipeg = {322, 149, 346, 123, 372, 97, 398, 73};
        routes.add(new Route(City.HELENA, City.WINNIPEG, Color.BLUE, 4, helena_winnipeg));
        int[] winnipeg_sault = {457, 56, 493, 63, 528, 70, 564, 78, 598, 84, 633, 91};
        routes.add(new Route(City.WINNIPEG, City.SAULT_ST_MARIE, Color.WILD, 6, winnipeg_sault));
        ...
        routes.add(new Route(City.HELENA, City.DULUTH, Color.ORANGE, 6, helena_duluth));
        int[] helena_slc = {243, 262, 262, 232, 280, 201};
        routes.add(new Route(City.HELENA, City.SALT_LAKE_CITY, Color.PINK, 3, helena_slc));
        int[] helena_denver = {310, 201, 324, 234, 336, 266, 350, 298};
        routes.add(new Route(City.HELENA, City.DENVER, Color.GREEN, 4, helena_denver));
        int[] helena_omaha = {335, 193, 369, 207, 401, 221, 435, 235, 468, 248};
        routes.add(new Route(City.HELENA, City.OMAHA, Color.RED, 5, helena_omaha));
        int[] slc_denver1 = {254, 296, 289, 303, 324, 310};
        routes.add(new Route(City.SALT_LAKE_CITY, City.DENVER, Color.RED, 3, slc_denver1));
        int[] slc_denver2 = {252, 308, 288, 315, 322, 322};
        routes.add(new Route(City.SALT_LAKE_CITY, City.DENVER, Color.YELLOW, 3, slc_denver2));
        int[] duluth_sault = {567, 146, 600, 131, 634, 117};
        routes.add(new Route(City.DULUTH, City.SAULT_ST_MARIE, Color.WILD, 3, duluth_sault));
        int[] duluth_omaha1 = {517, 198, 503, 230};
        routes.add(new Route(City.DULUTH, City.OMAHA, Color.WILD, 2, duluth_omaha1));
        int[] duluth_omaha2 = {529, 202, 516, 235};
        routes.add(new Route(City.DULUTH, City.OMAHA, Color.WILD, 2, duluth_omaha2));
        int[] omaha_kc1 = {511, 290};
        routes.add(new Route(City.OMAHA, City.KANSAS_CITY, Color.WILD, 1, omaha_kc1));
        int[] omaha_kc2 = {523, 285};
        routes.add(new Route(City.OMAHA, City.KANSAS_CITY, Color.WILD, 1, omaha_kc2));
        ...
        routes.add(new Route(City.DENVER, City.KANSAS_CITY, Color.ORANGE, 4, denver_kc2));
        int[] denver_ok = {373, 359, 403, 380, 438, 390, 474, 394};
        routes.add(new Route(City.DENVER, City.OKLAHOMA_CITY, Color.RED, 4, denver_ok));
        int[] kc_ok1 = {518, 336, 508, 371};
        routes.add(new Route(City.KANSAS_CITY, City.OKLAHOMA_CITY, Color.WILD, 2, kc_ok1));
        int[] kc_ok2 = {529, 340, 519, 376};
        routes.add(new Route(City.KANSAS_CITY, City.OKLAHOMA_CITY, Color.WILD, 2, kc_ok2));
        int[] phoenix_denver = {235, 448, 251, 416, 269, 387, 294, 360, 326, 341};
        routes.add(new Route(City.PHOENIX, City.DENVER, Color.WHITE, 5, phoenix_denver));
        int[] ok_santafe = {378, 419, 413, 415, 449, 410};
        routes.add(new Route(City.OKLAHOMA_CITY, City.SANTA_FE, Color.BLUE, 3, ok_santafe));
        int[] elpaso_ok = {370, 449, 404, 486, 436, 468, 463, 445, 487, 418};
        routes.add(new Route(City.EL_PASO, City.OKLAHOMA_CITY, Color.YELLOW, 5, elpaso_ok));
        int[] phoenix_santafe = {256, 459, 290, 443, 321, 429};
        routes.add(new Route(City.PHOENIX, City.SANTA_FE, Color.WILD, 3, phoenix_santafe));
        int[] phoenix_elpaso = {249, 482, 285, 493, 319, 502};
        routes.add(new Route(City.PHOENIX, City.EL_PASO, Color.WILD, 3, phoenix_elpaso));
        int[] santafe_elpaso = {346, 448, 344, 484};
        routes.add(new Route(City.SANTA_FE, City.EL_PASO, Color.WILD, 2, santafe_elpaso));
        int[] elpaso_houston = {364, 528, 398, 541, 433, 550, 469, 553, 506, 550, 540, 541};
        routes.add(new Route(City.EL_PASO, City.HOUSTON, Color.GREEN, 6, elpaso_houston));
        int[] elpaso_dallas = {389, 512, 424, 506, 460, 500, 496, 495};
        routes.add(new Route(City.EL_PASO, City.DALLAS, Color.RED, 4, elpaso_dallas));
        int[] ok_dallas1 = {510, 425, 515, 460};
        routes.add(new Route(City.OKLAHOMA_CITY, City.DALLAS, Color.WILD, 2, ok_dallas1));
        int[] ok_dallas2 = {523, 424, 527, 458};
        routes.add(new Route(City.OKLAHOMA_CITY, City.DALLAS, Color.WILD, 2, ok_dallas2));
        int[] dallas_houston1 = {538, 510};
        routes.add(new Route(City.DALLAS, City.HOUSTON, Color.WILD, 1, dallas_houston1));
        int[] dallas_houston2 = {548, 500};
        routes.add(new Route(City.DALLAS, City.HOUSTON, Color.WILD, 1, dallas_houston2));
        int[] houston_neworleans = {594, 522, 630, 516};
        routes.add(new Route(City.HOUSTON, City.NEW_ORLEANS, Color.WILD, 2, houston_neworleans));
        int[] dallas_littlerock = {552, 453, 573, 424};
        routes.add(new Route(City.DALLAS, City.LITTLE_ROCK, Color.WILD, 2, dallas_littlerock));
        int[] ok_littlerock = {533, 399, 569, 398};
        routes.add(new Route(City.OKLAHOMA_CITY, City.LITTLE_ROCK, Color.WILD, 2, ok_littlerock));
        int[] kc_stlouis1 = {550, 304, 587, 303};
        routes.add(new Route(City.KANSAS_CITY, City.SAINT_LOUIS, Color.BLUE, 2, kc_stlouis1));
        int[] kc_stlouis2 = {551, 317, 587, 316};
        routes.add(new Route(City.KANSAS_CITY, City.SAINT_LOUIS, Color.PINK, 2, kc_stlouis2));
        int[] omaha_chicago = {530, 250, 558, 231, 594, 223, 628, 228};
        routes.add(new Route(City.OMAHA, City.CHICAGO, Color.BLUE, 4, omaha_chicago));
        int[] duluth_chicago = {556, 186, 589, 201, 624, 212};
        routes.add(new Route(City.DULUTH, City.CHICAGO, Color.RED, 3, duluth_chicago));
        int[] duluth_toronto = {561, 164, 597, 158, 632, 152, 669, 146, 704, 140, 740, 134};
        routes.add(new Route(City.DULUTH, City.TORONTO, Color.PINK, 6, duluth_toronto));
        ...
        routes.add(new Route(City.NEW_ORLEANS, City.LITTLE_ROCK, Color.GREEN, 3, neworleans_littlerock));
        int[] littlerock_saintlouis = {599, 374, 608, 339};
        routes.add(new Route(City.LITTLE_ROCK, City.SAINT_LOUIS, Color.WILD, 2, littlerock_saintlouis));
        ...
        routes.add(new Route(City.CHICAGO, City.TORONTO, Color.WHITE, 4, chicago_toronto));
        int[] neworleans_miami = {696, 508, 729, 494, 765, 489, 800, 498, 830, 519, 854, 543};
        routes.add(new Route(City.NEW_ORLEANS, City.MIAMI, Color.RED, 6, neworleans_miami));
        ...
        routes.add(new Route(City.LITTLE_ROCK, City.NASHVILLE, Color.WHITE, 3, littlerock_nashville));
        int[] saintlouis_nashville = {637, 335, 671, 346};
        routes.add(new Route(City.SAINT_LOUIS, City.NASHVILLE, Color.WILD, 2, saintlouis_nashville));
        int[] saintlouis_pittsburgh = {637, 307, 668, 290, 699, 271, 730, 253, 761, 236};
        routes.add(new Route(City.SAINT_LOUIS, City.PITTSBURGH, Color.GREEN, 5, saintlouis_pittsburgh));
        ...
        routes.add(new Route(City.ATLANTA, City.MIAMI, Color.BLUE, 5, atlanta_miami));
        int[] atlanta_chareston = {787, 398, 823, 400};
        routes.add(new Route(City.ATLANTA, City.CHARLESTON, Color.WILD, 2, atlanta_chareston));
        int[] miami_charleston = {877, 524, 862, 490, 855, 456, 851, 419};
        routes.add(new Route(City.MIAMI, City.CHARLESTON, Color.PINK, 4, miami_charleston));
        int[] atlanta_raleigh1 = {779, 376, 807, 351};
        routes.add(new Route(City.ATLANTA, City.RALEIGH, Color.WILD, 2, atlanta_raleigh1));
        int[] atlanta_raleigh2 = {772, 364, 799, 341};
        routes.add(new Route(City.ATLANTA, City.RALEIGH, Color.WILD, 2, atlanta_raleigh2));
        int[] raleigh_charleston = {842, 345, 859, 370};
        routes.add(new Route(City.RALEIGH, City.CHARLESTON, Color.WILD, 2, raleigh_charleston));
        int[] nashville_atlanta = {727, 368};
        routes.add(new Route(City.NASHVILLE, City.ATLANTA, Color.WILD, 1, nashville_atlanta));
        ...
        routes.add(new Route(City.NASHVILLE, City.PITTSBURGH, Color.YELLOW, 4, nashville_pittsburgh));
        int[] pittsburgh_raleigh = {800, 255, 808, 289};
        routes.add(new Route(City.PITTSBURGH, City.RALEIGH, Color.WILD, 2, pittsburgh_raleigh));
        int[] pittsburgh_washington = {818, 234, 850, 250};
        routes.add(new Route(City.PITTSBURGH, City.WASHINGTON, Color.WILD, 2, pittsburgh_washington));
        int[] washington_raleigh1 = {859, 278, 835, 306};
        routes.add(new Route(City.WASHINGTON, City.RALEIGH, Color.WILD, 2, washington_raleigh1));
        int[] washington_raleigh2 = {868, 286, 845, 313};
        routes.add(new Route(City.WASHINGTON, City.RALEIGH, Color.WILD, 2, washington_raleigh2));
        ...
        routes.add(new Route(City.PITTSBURGH, City.TORONTO, Color.WILD, 2, pittsburgh_toronto));
        int[] toronto_montreal = {773, 98, 796, 70, 827, 50};
        routes.add(new Route(City.TORONTO, City.MONTREAL, Color.WILD, 3, toronto_montreal));
        int[] montreal_boston1 = {880, 51, 907, 74};
        routes.add(new Route(City.MONTREAL, City.BOSTON, Color.WILD, 2, montreal_boston1));
        int[] montreal_boston2 = {871, 62, 899, 84};
        routes.add(new Route(City.MONTREAL, City.BOSTON, Color.WILD, 2, montreal_boston2));
        ...
        routes.add(new Route(City.PORTLAND, City.SALT_LAKE_CITY, Color.BLUE, 6, portland_slc));
        ...
        routes.add(new Route(City.LOS_ANGELES, City.LAS_VEGAS, Color.WILD, 2, la_lasvegas));
        int[] la_phoenix = {130, 458, 166, 456, 202, 461};
        routes.add(new Route(City.LOS_ANGELES, City.PHOENIX, Color.WILD, 3, la_phoenix));
        ...
        routes.add(new Route(City.LAS_VEGAS, City.SALT_LAKE_CITY, Color.ORANGE, 3, lasvegas_slc));
        int[] vancouver_seattle1 = {57, 88};
        routes.add(new Route(City.VANCOUVER, City.SEATTLE, Color.WILD, 1, vancouver_seattle1));
        int[] vancouver_seattle2 = {71, 87};
        routes.add(new Route(City.VANCOUVER, City.SEATTLE, Color.WILD, 1, vancouver_seattle2));
        int[] seattle_portland1 = {45, 137};
        routes.add(new Route(City.SEATTLE, City.PORTLAND, Color.WILD, 1, seattle_portland1));
        int[] seattle_portland2 = {57, 141};
        routes.add(new Route(City.SEATTLE, City.PORTLAND, Color.WILD, 1, seattle_portland2));
        int[] portland_sanfrancisco1 = {23, 190, 18, 227, 13, 263, 15, 297, 20, 333};
        routes.add(new Route(City.PORTLAND, City.SAN_FRANCISCO, Color.GREEN, 5, portland_sanfrancisco1));
        int[] portland_sanfrancisco2 = {35, 190, 28, 227, 23, 263, 25, 297, 30, 333};
        routes.add(new Route(City.PORTLAND, City.SAN_FRANCISCO, Color.PINK, 5, portland_sanfrancisco2));
        int[] denver_santafe = {350, 359, 348, 394};
        routes.add(new Route(City.DENVER, City.SANTA_FE, Color.WILD, 2, denver_santafe));
        int[] sault_toronto = {693, 109, 729, 116};
        routes.add(new Route(City.SAULT_ST_MARIE, City.TORONTO, Color.WILD, 2, sault_toronto));
        int[] denver_omaha = {376, 309, 407, 289, 441, 277, 476, 268};
        routes.add(new Route(City.DENVER, City.OMAHA, Color.PINK, 4, denver_omaha));
        int[] montreal_ny = {850, 70, 856, 106, 862, 140};
        routes.add(new Route(City.MONTREAL, City.NEW_YORK, Color.BLUE, 3, montreal_ny));
    }
}
